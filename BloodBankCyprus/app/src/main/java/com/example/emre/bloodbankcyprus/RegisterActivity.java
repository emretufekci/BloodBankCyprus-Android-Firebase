                ...
                mAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(RegisterActivity.this, "Error is"+errorMessage, Toast.LENGTH_LONG).show();
                   ...
                   Toast.makeText(RegisterActivity.this, "Passwords are not matching, you should type same password both", Toast.LENGTH_LONG).show();
